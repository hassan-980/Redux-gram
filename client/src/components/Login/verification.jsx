...
import { sendEmailVerifyOtp,verifyEmail } from '../../../features/auth/authSlice';
...
const navigate = useNavigate()
  ...
  const { loading, error, user,loggedIn , isverified } = useSelector((state) => state.auth);
    ...
    <div className="relative mt-12 w-full max-w-lg sm:mt-10 ">
        ...
        <div
            ...
            <div className="flex flex-col p-6">
                <h3 className="text-xl font-semibold leading-6 tracking-tighter">Verification</h3>
            ...
            <div className="p-6 pt-0">
                        ...
                        <div>
                            <div
                                ...
                                <div className="flex justify-between">
                                    <label
                                        className="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Enter OTP</label>
                         ...
                         {otpsend && <p className="text-gray-600 mt-2">A one-time password (OTP) has been sent to your registered email address and will be valid for 10 minutes. </p>}
                    </div>
                ...
                <div className='flex w-full justify-center'>
                    ...
                    >{otpsend? "Resend OTP":'send OTP'  }</button>
