            ...
            <div className="sm:p-6 p-4 pt-0">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-4 flex items-center justify-end gap-x-2">
                  <Link
                    className="flex items-center justify-center rounded-md text-sm font-medium transition-all  focus-visible:ring-offset-2  hover:ring dark:hover:ring-white hover:ring-black h-10 px-4 py-2 duration-200"
                    to="/signup"
                  >
                    Register
                  </Link>
