        ...
        <div className="dark:bg-black text-white flex min-h-screen flex-col items-center   sm:justify-center sm:pt-0">
          ...
          {loading ? (
            ...
            <p className="mt-6 text-sm font-bold text-gray-600">
              No more posts, you reached at the bottom
            </p>
          ) : (
            <button
              className="mt-4 flex items-center justify-center rounded-xl bg-blue-600  text-sm font-semibold text-white shadow-sm transition-all duration-150 h-10 w-25 cursor-pointer  "
