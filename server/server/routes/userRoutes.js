...
import { getUserData,deleteUser, getAllUsers, updateProfilePic, getProfilePic } from '../controllers/userController.js';
...
userRouter.post('/update-profile-pic',upload.single("image"),userAuth,updateProfilePic)
